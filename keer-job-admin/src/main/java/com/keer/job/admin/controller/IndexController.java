...
import com.keer.job.admin.controller.interceptor.PermissionInterceptor;
...
public class IndexController {
    ...
    public ReturnT<Map<String, Object>> triggerChartDate() {
        ReturnT<Map<String, Object>> trigger = xxlJobService.triggerChartDate();
        return trigger;
    }
    ...
    public ReturnT<String> loginDo(HttpServletRequest request,
        ...
        if (!PermissionInterceptor.ifLogin(request)) {
            if (StringUtils.isNotBlank(userName) && StringUtils.isNotBlank(password)
                    && PropertiesUtil.getString("keer.job.login.username").equals
                    (userName) && PropertiesUtil.getString("keer.job.login.password")
                    .equals(password)) {
                boolean ifRem = false;
        ...
        System.out.println("ReturnT.SUCCESS:>>>" + ReturnT.SUCCESS);
